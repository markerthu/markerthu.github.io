...
<div class="fcard"><div class="fhead"><div class="fno">3</div><div class="fclaim">So reward the process, not just the answer</div></div><p class="fev">Outcome-only RLVR scores the final token and ignores the road to it. CESAR adds <b>five reward terms, three of them process-level</b> — consistency, structure, logic, domain grounding, and a penalty on overthinking.</p><div class="fptr">§03 &middot; the fix</div></div>
...
<div class="fig bleed"><svg viewBox="0 0 940 560" role="img" aria-label="MMSU: reasoning against perception. CESAR reaches 81.07 on reasoning, close to the human 86.77, but only 48.45 on perception against a human 91.24. Every system sits far below the human point on perception and much nearer it on reasoning."><defs><style>.sx{font-family:var(--mono);font-size:10px;fill:var(--muted)}.sl{font-family:var(--sans);font-size:11.5px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;fill:var(--muted)}.pn{font-family:var(--sans);font-size:12.5px;font-weight:700;fill:var(--ink)}.ps{font-family:var(--sans);font-size:10.5px;fill:var(--muted)}.gp{font-family:var(--sans);font-size:11.5px;font-weight:700;fill:var(--ed-neg)}</style></defs><line x1="180.0" y1="60" x2="180.0" y2="460" stroke="var(--rule)"/><text class="sx" x="180.0" y="478" text-anchor="middle">70</text><line x1="355.0" y1="60" x2="355.0" y2="460" stroke="var(--rule)"/><text class="sx" x="355.0" y="478" text-anchor="middle">75</text><line x1="530.0" y1="60" x2="530.0" y2="460" stroke="var(--rule)"/><text class="sx" x="530.0" y="478" text-anchor="middle">80</text><line x1="705.0" y1="60" x2="705.0" y2="460" stroke="var(--rule)"/><text class="sx" x="705.0" y="478" text-anchor="middle">85</text><line x1="880.0" y1="60" x2="880.0" y2="460" stroke="var(--rule)"/><text class="sx" x="880.0" y="478" text-anchor="middle">90</text><line x1="110" y1="432.9" x2="880" y2="432.9" stroke="var(--rule)"/><text class="sx" x="102" y="436.9" text-anchor="end">40</text><line x1="110" y1="365.1" x2="880" y2="365.1" stroke="var(--rule)"/><text class="sx" x="102" y="369.1" text-anchor="end">50</text><line x1="110" y1="297.3" x2="880" y2="297.3" stroke="var(--rule)"/><text class="sx" x="102" y="301.3" text-anchor="end">60</text><line x1="110" y1="229.5" x2="880" y2="229.5" stroke="var(--rule)"/><text class="sx" x="102" y="233.5" text-anchor="end">70</text><line x1="110" y1="161.7" x2="880" y2="161.7" stroke="var(--rule)"/><text class="sx" x="102" y="165.7" text-anchor="end">80</text><line x1="110" y1="93.9" x2="880" y2="93.9" stroke="var(--rule)"/><text class="sx" x="102" y="97.9" text-anchor="end">90</text><line x1="180.0" y1="229.5" x2="880.0" y2="93.9" stroke="var(--muted)" stroke-width="1" stroke-dasharray="5 5" opacity=".5"/><text class="ps" x="670.0" y="125.1" transform="rotate(-38 670.0 125.1)" fill="var(--muted)">equal on both</text><line x1="567.4" y1="375.6" x2="567.4" y2="85.5" stroke="var(--ed-neg)" stroke-width="2" stroke-dasharray="4 4" opacity=".65"/><text class="gp" x="579.4" y="229.5">42.8 points of perception still missing</text><circle cx="567.4" cy="375.6" r="9" fill="var(--ed-accent)"/><circle cx="524.0" cy="415.9" r="6" fill="var(--muted)" opacity=".62"/><circle cx="462.1" cy="384.8" r="6" fill="var(--muted)" opacity=".62"/><circle cx="395.6" cy="391.5" r="6" fill="var(--muted)" opacity=".62"/><circle cx="248.6" cy="435.1" r="6" fill="var(--muted)" opacity=".62"/><circle cx="766.9" cy="85.5" r="8" fill="var(--ed-neg)"/><text class="sl" x="495" y="506" text-anchor="middle">reasoning &rarr;</text><text class="sl" x="26" y="260" transform="rotate(-90 26 260)" text-anchor="middle">perception &rarr;</text><text class="pn" x="583.4" y="361.6" text-anchor="start" fill="var(--ed-accent)">CESAR</text><text class="ps" x="583.4" y="376.6" text-anchor="start">ours &middot; 81.07 / 48.45</text><text class="pn" x="510.0" y="399.9" text-anchor="end">Ke-Omni-R</text><text class="ps" x="510.0" y="414.9" text-anchor="end">outcome-only RL &middot; 78.06 / 47.09</text><text class="pn" x="448.1" y="368.8" text-anchor="end">Gemini 1.5 Pro</text><text class="ps" x="448.1" y="383.8" text-anchor="end">proprietary &middot; 76.16 / 46.10</text><text class="pn" x="381.6" y="425.5" text-anchor="end">Qwen2.5-Omni-7B</text><text class="ps" x="381.6" y="440.5" text-anchor="end">base &middot; 79.83 / 42.50</text><text class="pn" x="264.6" y="421.1" text-anchor="start">GPT-4o Audio</text><text class="ps" x="264.6" y="436.1" text-anchor="start">proprietary &middot; 71.96 / 39.67</text><text class="pn" x="750.9" y="71.5" text-anchor="end" fill="var(--ed-neg)">Human</text></svg></div><p class="cap"><b>Reasoning is nearly solved; perception is not.</b> Each point is one system on MMSU, reasoning on the horizontal axis and perception on the vertical. Every system sits far below the dashed parity line: they all reason far better than they hear. CESAR posts the best reasoning score of the group at 81.07, within six points of the human 86.77 &mdash; while its perception, at 48.45, is 42.8 points short of the human 91.24. That asymmetry is the finding: process rewards move reasoning close to human parity and lift perception with it, but the perceptual bottleneck is what remains.</p>
